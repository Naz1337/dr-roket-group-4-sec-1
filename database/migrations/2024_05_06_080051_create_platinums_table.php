...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('platinums', function (Blueprint $table) {
            ...
            $table->integer('plat_discover_type');
            $table->integer('plat_prog_interest');
            $table->integer('plat_batch');
            $table->string('plat_referral_name')->nullable();
            $table->integer('plat_referral_batch')->nullable();
            ...
            $table->binary('plat_payment_proof');
            $table->timestamps();
        });
    }
